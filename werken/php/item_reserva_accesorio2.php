...
<tr><td>ADVERTENCIA: Antes de realizar una reserva, debe considerar que de no retirar el libro en un
		  ...
		  <font color="red">suspenderá por cinco días hábiles</font></strong>.</td></tr>
<tr><td>&nbsp;</td></tr>
</table>
...
<?php 
	...
	while ($row = $d->get_row()) { 
		$total++; ?>    
      <tr class='tr-color-hi'><td colspan='2' class='texto-tabla'>Título del accesorio a Reservar</td></tr>
      <tr> 
