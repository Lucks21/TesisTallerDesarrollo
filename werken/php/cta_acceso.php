...
<blockquote>
      <form name="frm" action="cta_prestamos.php" method="post" onSubmit="return valida_cuenta(this);">
          ...
          <table width="372" border="0" >
            ...
            <li><font face="Verdana, Arial, Helvetica, sans-serif">Para concocer 
              su clave de usuario, debe dirigirse a su Biblioteca y consultar en 
              forma personal.</font></li>
            <li><b><font face="Verdana, Arial, Helvetica, sans-serif">Si desea 
              cambiar su clave de acceso haga <a href="cambio_password.php">click 
              aqu&iacute;</a></font></b></li>
                  </ul>
                  </td>
            </tr>
				<tr><td>&nbsp;</td></tr>
            <tr><td align="right"><a href="javascript:window.close()"><img src="../images/etiquetas/cerrar_ventana.gif" width="90" height="19" border="0"></a>&nbsp;</td></tr>				
          </table>
        </div>
      </form>
</blockquote>      
